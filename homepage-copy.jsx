...
window.COPY = {
  ja: {
    ...
    freeStart: {
      label: 'Free で開始',
      title: '無料で検証を始める',
      subtitle: 'Free プランでは、バックテスト・ウォークフォワード分析・ベイズ最適化をローカル環境で試せます。Whop で無料登録 → CLI インストール → ログイン認証の 3 ステップで開始できます。',
      primaryCta: '3 ステップで始める',
      secondaryCta: '料金比較を見る',
      updateCta: '更新情報をXで追う',
      availability: 'Free 登録・販売開始は今夏提供開始予定です。現時点では Whop 登録・インストール手順と提供範囲を確認できます。',
      outExamplesCta: '出力サンプルを見る',
      steps: [
        { num: '01', title: 'Whop で登録（無料）', desc: 'AlphaForge は Free プランも含めて Whop アカウント登録が必須です。クレジットカード不要で登録できます。' },
        { num: '02', title: 'インストール & ログイン認証', desc: 'macOS / Linux / Windows 向けの CLI を 1 コマンドで導入し、Whop アカウントで OAuth 認証します。' },
        { num: '03', title: 'サンプル戦略を実行 & 結果確認', desc: '用意された戦略 JSON でバックテストを実行し、指標・損益曲線・最適化結果を確認します。' },
      ],
      limits: [
        'データは2023年12月31日まで',
        '最適化50回',
    ...
    pricing: {
      ...
      freePlan: {
        ...
        ctaLabel: '$0 で Whop に登録',
        ctaHint: '続いてインストール手順へ',
  ...
  en: {
    ...
    freeStart: {
      ...
      subtitle: 'The Free plan lets you try backtesting, walk-forward analysis, and Bayesian optimization locally. Sign up on Whop → install the CLI → sign in — three steps to get going.',
      primaryCta: 'Start in 3 steps',
      secondaryCta: 'Compare plans',
      updateCta: 'Follow updates on X',
      availability: 'Free registration and paid plans are scheduled for this summer. For now, you can review the Whop signup and install flow and plan limits.',
      outExamplesCta: 'See output samples',
      steps: [
        { num: '01', title: 'Register on Whop (free)', desc: 'AlphaForge requires a Whop account for every plan, including Free. No credit card needed.' },
        { num: '02', title: 'Install & sign in', desc: 'Install the CLI with a single command on macOS, Linux, or Windows, then authenticate via Whop OAuth.' },
        { num: '03', title: 'Run a sample strategy & review results', desc: 'Backtest a ready-made strategy JSON and inspect metrics, the equity curve, and optimization results.' },
      ],
      limits: [
    ...
    pricing: {
      ...
      freePlan: {
        ...
        ctaLabel: 'Register on Whop ($0)',
        ctaHint: 'Then view install steps',
