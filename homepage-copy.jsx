      ...
      items: [
        {
          ...
          desc: 'JSON定義の設定をvectorbtで高速シミュレーション。Optunaによるベイズ最適化・時系列クロスバリデーションで過学習を防ぎ、結果をCLIレポートとして出力。Claude連携でパラメータを自律探索。',
    ...
    usecases: {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'Logistics',
          title: '需要予測・在庫最適化',
          desc: 'ロジスティクス・小売・エネルギーインフラにおける需要系列を時系列クロスバリデーションでロバストに検証。過学習を排除した予測モデルで供給チェーンの効率を向上させます。',
          tags: ['需要予測', '時系列CV', 'サプライチェーン', 'インフラ'],
        },
        {
          icon: '📊',
          accent: 'var(--accent)',
          label: 'Data Science',
          title: 'データサイエンス・機械学習',
          desc: '大規模時系列データセットに統計モデリングと機械学習パイプラインを適用。パラメータ最適化と時系列クロスバリデーションで、モデルの汎化性能を客観的に評価できます。',
          tags: ['統計モデリング', 'ML パイプライン', '時系列クロスバリデーション', 'データサイエンス'],
        },
      ],
    },
    perf: {
      ...
      items: [
        {
          ...
          desc: 'High-speed time-series simulation with vectorbt. Bayesian optimization via Optuna + rolling-window cross-validation to prevent overfitting. CLI report output. Claude integration for autonomous parameter exploration.',
          tags: ['Python', 'vectorbt', 'Optuna', 'Streamlit', 'JSONL'],
          accent: 'var(--blue)',
        },
        {
    ...
    usecases: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'Robustly validate demand series in logistics, retail, and energy infrastructure with rolling-window cross-validation. Eliminate overfitting with proven models to improve supply chain efficiency.',
          tags: ['Demand Forecasting', 'Time-Series CV', 'Supply Chain', 'Infrastructure'],
        },
        {
          icon: '📊',
          accent: 'var(--accent)',
